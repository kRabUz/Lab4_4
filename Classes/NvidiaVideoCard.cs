...
{
    public class NvidiaVideoCard : AbstractVideoCardComponent
    {
        public NvidiaVideoCard(string model, string article, decimal price) : base("NVIDIA", model, article, price)
        {
        }
