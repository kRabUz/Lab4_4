...
{
    public class AmdProcessor : AbstractProcessorComponent
    {
        public AmdProcessor(int clockFrequency, int numberOfCores, string article, decimal price) : base("AMD", clockFrequency, numberOfCores, article, price)
        {
        }
